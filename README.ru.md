...
Installer сначала проверяет роутер, затем скачивает четыре LuCI-пакета и
подходящий бинарник `fnc`, проверяет каждый файл по SHA-256, автоматически
выбирает APK или IPK, сохраняет установленную версию релиза и ставит `fnc` в
